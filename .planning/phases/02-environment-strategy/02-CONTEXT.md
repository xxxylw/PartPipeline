...
- 	hird_party/SAMPart3D/tools/run_sampart3d_object.py exists and will be used in Phase 3.
- 	hird_party/HoloPart/scripts/inference_holopart.py exists and will be used in Phase 5.
...
- 	hird_party/SAMPart3D/requirements.txt - SAMPart3D dependency requirements.
- 	hird_party/HoloPart/requirements.txt - HoloPart dependency requirements.
